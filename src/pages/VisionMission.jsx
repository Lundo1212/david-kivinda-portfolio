export default function VisionMission() {
  return (
    <div className="w-full bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="max-w-5xl mx-auto px-4 py-20 flex flex-col space-y-16">
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-center">Vision & Mission</h1>

        <section className="text-center">
          <h2 className="text-2xl md:text-3xl font-semibold text-yellow-400 mb-4">Vision</h2>
          <p className="text-base md:text-lg leading-relaxed text-gray-300 mx-auto max-w-3xl">
            To become a globally impactful technologist, designing intelligent, secure, and scalable digital systems that bridge scientific rigor with innovative software engineering to advance society.
          </p>
        </section>

        <section className="text-center">
          <h2 className="text-2xl md:text-3xl font-semibold text-emerald-400 mb-4">Mission</h2>
